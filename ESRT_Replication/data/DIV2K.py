...
class div2k(data.Dataset):
    ...
    def _set_filesystem(self, dir_data):
        self.root = '/home/airl-gpu4/Aniruddh/PBVS_Challenge/Datasets/train_images/train_images/'
        self.dir_hr = os.path.join(self.root, 'EO_data_er_imbalanced_highres/0/')
        self.dir_lr = os.path.join(self.root, 'EO_data_er_imbalanced_npy/0/')
        """
